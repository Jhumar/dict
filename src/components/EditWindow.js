        ...
        <Row className='mb-3'>
          <Col className='mb-3' lg={6}>
            <Form.Group controlId='formWindowName'>
              ...
              <Form.Control type='text' name='name' placeholder='E.g. Window 1' value={window.name} onChange={handleFormDataOnChange} />
            </Form.Group>
          </Col>
          ...
          <Col className='mb-3' lg={6}>
            <Form.Group controlId='formAssignUser'>
              ...
              <Form.Select name='teller_id' value={window.teller_id} onChange={handleFormDataOnChange} required>
          ...
          <Col className='mb-3' lg={6}>
            <Form.Group>
              ...
              <Form.Select name='type' value={window.type} onChange={handleFormDataOnChange} required>
          ...
          <Col className='mb-3' lg={6}>
            ...
            {hasDepartment && (
              <Form.Select name='department' value={window.department} onChange={handleFormDataOnChange} required>
