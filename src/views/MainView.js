    ...
    <>
      <Container fluid className='p-0'>
        <ViewingNavbar/>
          <Row className='me-0'>
            ...
            <Col xl={4} className="p-0">
              <div className='d-flex flex-column'>
                <div style={{ height: "45vh"}} className="d-flex justify-content-center align-items-center bg-secondary">News</div>
                <div style={{ height: "45vh"}} className="d-flex justify-content-center align-items-center bg-secondary">News</div>
              </div>
            </Col>
          </Row>
          ...
          <marquee className='bg-dark text-danger fixed-bottom fs-4'>LAGUNA STATE POLYTECHNIC UNIVERSITY</marquee>
      </Container>
    </>
  );
}
